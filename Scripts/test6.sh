...
# Create our final working docker-compose
cat > docker-compose.final.yml << 'EOL'
version: '3.4'
services:
  bucstop:
...
echo "Starting containers with final configuration..."
...
echo "Container logs:"
sleep 10
docker logs bucstop 2>&1 | tail -n 20
